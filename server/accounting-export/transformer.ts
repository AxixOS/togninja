...
export class CLSTransformer {
   ...
   */
  static toCLSInvoice(crmInvoice: any): CLSInvoice {
   ...
   */
  private static extractLines(crmInvoice: any): CLSInvoiceLine[] {
   ...
   */
  static toCLSCustomer(crmClient: any): CLSCustomer {
    return {
      id: crmClient.id,
   ...
   */
  static toCLSPayment(crmPayment: any): CLSPayment {
    return {
      id: crmPayment.id,
   ...
   */
  static getStandardTaxRates(): CLSTaxRate[] {
    return [
      {
        tax_code: 'AT-20',
        rate: 0.20,
   ...
   */
  private static normalizeStatus(status: any): CLSInvoice['status'] {
