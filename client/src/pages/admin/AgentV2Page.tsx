      ...
      <div className="bg-gradient-to-br from-violet-50 via-purple-50 to-pink-50 min-h-screen">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl shadow-md p-6 border border-purple-100">
            ...
            <p className="text-gray-600 text-sm">
              55 registered tools, every one with a Zod parameter schema: search, reporting,
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8 border border-gray-200">
          <h3 className="font-semibold text-lg mb-4">
            Available Tools <span className="font-normal text-gray-500 text-base">(55 registered — a representative selection below)</span>
          </h3>
